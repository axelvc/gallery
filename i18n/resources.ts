  ...
  en: {
    translation: {
      entry: {
        ...
        startBlankCopy: 'Open the gallery with no imported profile and arrange your own photos from scratch.',
  ...
  es: {
    translation: {
      entry: {
        ...
        startBlankCopy: 'Abre la galería sin un perfil importado y organiza tus propias fotos desde cero.',
